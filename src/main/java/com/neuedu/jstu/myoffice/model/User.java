...
public class User implements Serializable {
    private static final long serialVersionUID = 5482086273898847726L;
    ...
    public User(Integer id, String name, Integer sex, Date birth, String idcard, Integer departmentid, String departmentname, Integer stationid, String stationname, Date employdate, Date workdate, Integer form, String source, String politics, String folk, String nation, String phone, String email, String height, String blood, String status, String homeplace, String seat, String eduback, String edudegree, String graschool, String speciality, Date gradate, Integer tag) {
        this.id = id;
        this.name = name;
        this.sex = sex;
        this.birth = birth;
    ...
    public User(Integer id, String name, Integer sex, Integer tag) {
        this.id = id;
        this.name = name;
        this.sex = sex;
        this.tag = tag;
